...
public class DeptController {
    ...
    @Autowired
    private DepttServicel depttService;
...
/*        @GetMapping("/home")
    ...
    public AjaxResponse queryList(){
        List<Depta> list = depttService.queryList();
    ...
    //查询部门有哪些
    @GetMapping(value = "/chabudept")
    public List<Dept> girlList11(){
        return deptService.findAll11();
    }
